...
export const companyTypeActions = createActionGroup({
	...
	events: {
		...
		'Create Success': props<ApiActionSave<CompanyType> & ApiActionSuccess>(),
		'Create Error': props<ApiActionSave<CompanyType> & ApiActionError>(),
		'Delete': props<ApiActionSave<CompanyType>>(),
		'Delete Success': props<ApiActionSave<CompanyType> & ApiActionSuccess>(),
		...
		'Update Success': props<ApiActionSave<CompanyType> & ApiActionSuccess>(),
		'Update Error': props<ApiActionSave<CompanyType> & ApiActionError>(),
	},
});
